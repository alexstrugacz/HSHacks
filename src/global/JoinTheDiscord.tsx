    ...
    return (
        <div>
            <a href={JOIN_THE_DISCORD} target="_blank">
                <button className={`text-white font-Poppins text-lg md:text-xl font-bold py-3 px-5 pr-3 mt-12 rounded-full bg-gradient-to-tl  from-[#CF424D] to-[#E96C2E] hover:scale-105 transition-all`}>
