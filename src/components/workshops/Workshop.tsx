...
const Workshop: React.FC<{}> = (props) => {
    ...
    return (
        <div className={`bg-gradient-to-b bg-[#0D1117] min-h-screen font-Poppins`}>
            ...
            }} className={`${styles.markdown} p-10 pt-10 max-w-4xl mx-auto bg-slate-900 list-disc`} source={workshopHook.markdown} />
        </div>
    );
}
