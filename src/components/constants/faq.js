export const FAQ = [
  {
    ...
    answer:
      "A hackathon is a 12-hour event where students come together to create a project from scratch. It is a great opportunity to learn new skills, meet new people, and have fun!",
    col: 1,
  },
  {
  ...
  },
  {
    ...
    answer:
      "All you need to bring is your laptop, charger, and a valid student ID. We will provide food, drinks, and swag for all participants. Let us know if you don't have a laptop, and we can supply one.",
    col: 1,
  },
  ...
  },
  {
    ...
    answer:
      "Contact us at team@hshacks.org for any questions or concerns. We will be happy to help you out!",
    col: 2,
    isEmail: true,
  },
];
