        ...
        <div className="md:h-[303px] h-full md:bg-[#D9D9D9] bg-[#E0E0E0] w-screen">
            <div className="md:flex">
                <div className="md:mt-8 mr-[15vh] ml-[15vh] md:ml-[10vh] md:mr-[15vh]">
                    <img className="pt-8 md:pt-0 md:ml-[10vh] scale-[1.7] object-fit md:scale-[1.2] md:mt-5" src={getprizes}></img>
                </div>
                <div className="md:ml-[20vh] ml-[5vh] pt-10 md:pt-16 md:mt-3">
                    <h2 className="font-Poppins font-bold text-2xl pt-4 md:text-3xl">🎁 Get <a className="text-transparent bg-clip-text bg-gradient-to-r from-[#CF424D] to-[#FB7B3C]">prizes & swag</a></h2>
