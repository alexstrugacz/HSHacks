...
import joinworkshops from "../../../assets/images/workshops.jpg"
        ...
        <div className={"w-full"}>
            <div className="flex flex-col md:flex-row items-start py-0 px-5 md:px-20 mx-auto max-w-6xl gap-10">
                <div className={"md:hidden flex-1 flex flex-col items-center w-full"}>
                    ...
                    <p className={"mt-5 text-zinc-400 font-Poppins mr-3 text-sm text-left w-full pl-2"}>Workshop at the JHHS Hack Club</p>
                </div>
                ...
                <div className={"flex flex-1 flex-col items-center hidden md:block"}>
                    <img src={joinworkshops} className={"object-cover w-full h-full rounded-xl shadow-lg scale-100 hover:scale-105 transition-all h-64"} />
                    <p className={"mt-5 text-zinc-400 font-Poppins mr-3 text-sm text-center"}>Workshop at the JHHS Hack Club</p>
                </div>
            </div >
        </div>
    )
