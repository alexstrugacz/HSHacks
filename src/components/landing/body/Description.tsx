        ...
        <div>
            <div className="w-full h-[342px] bg-gradient-to-b from-[#E4E4E7] to-[#D4D4D4]">
                <div className="ml-[15vh] pt-8 font-Poppins text-2xl">
                    <h2 className="font-bold font-Poppins text-[29px]">12 hours of <a className="text-transparent bg-clip-text bg-gradient-to-r from-[#CF424D] to-[#FB7B3C]">coding, workshops, and fun!</a></h2>
