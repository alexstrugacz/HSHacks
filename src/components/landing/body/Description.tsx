        ...
        <div>
            <div className="w-full py-12">
                <div className="max-w-6xl font-Poppins text-2xl px-5 md:px-20 my-5 mx-auto">
                    <h2 className="font-bold font-Poppins text-xl pb-3 border-b-2 border-b-[#3f6fa650]">12 hours of <a className="text-[#338eda]">coding, workshops, and fun!</a></h2>
