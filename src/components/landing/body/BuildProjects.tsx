        ...
        <div className={"w-full pt-10"}>
            ...
            <div className="flex flex-col md:flex-row items-start py-5 pt-5 px-5 md:px-20 mx-auto max-w-6xl gap-10">
                <div className={`flex-1 w-full`}>
                    ...
                    <p className={"mt-4 text-zinc-400 font-Poppins mr-3 text-sm w-full md:text-center"}>One of Project Headspace & Timing's Events</p>
                </div>
                <div className="flex-1 md:pt-7">
                    <FireIcon className={"w-8 text-zinc-600 mb-1"} />
                    <h2 className="font-Poppins md:pt-0 font-bold text-2xl md:text-3xl">Build <a className="text-transparent bg-clip-text text-[#338EDA]">projects</a> for a nonprofit</h2>
