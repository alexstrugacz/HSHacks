...
import projects from "../../../assets/images/hshacks-3.jpg"
        ...
        <div className={"w-full pt-10"}>
            ...
            <div className="flex flex-col md:flex-row items-start py-5 pt-5 px-5 md:px-20 mx-auto max-w-6xl gap-10">
                ...
                <div className="flex-1 md:pt-7">
                    ...
                    <h2 className="font-Poppins md:pt-0 font-bold text-2xl md:text-3xl">Build <a className="bg-clip-text text-[#338eda]">projects</a></h2>
                    <p className={"font-Poppins text-zinc-800 mt-3 text-lg"}>Go solo or join a group of 3-5 to build an awesome projects within the hackathon!</p>
                    <br />
