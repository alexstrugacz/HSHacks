...
const ReadyToBuild: React.FC<{}> = () => {
    ...
    return (
        <div className={"relative w-full overflow-hidden h-[1000px] bg-neutral-900"}>
            <video
                muted
                autoPlay
                playsInline
                ...
                <div className="max-w-6xl w-full mx-auto px-5 md:px-20">
                    ...
                    <div className="mt-8">
                        ...
                        <div onClick={openHerseyLink} className="group flex gap-2 mr-16 items-center hover:cursor-pointer w-fit">
                            ...
                            <h2 className="font-bold text-white font-Poppins group-hover:text-zinc-400 transition-colors">John Hersey High School ARC</h2>
                        </div>
                        <div className="flex mt-2 md:mt-3">
                            ...
                            <h2 className="font-bold text-white font-Poppins ">April 20, 2024</h2>
                        </div>
                    </div>
                    <JoinTheDiscord />
