...
const ReadyToBuild: React.FC<{}> = () => {
    return (
        <div>
            ...
            <div className="flex">
                <div className="absolute md:ml-[10vh] ml-[5vh] md:mt-[15vh] mt-[10vh] mr-[5vh] md:mr-0">
                    <h2 className="font-bold text-white font-Poppins md:text-6xl text-5xl leading-tight">Ready to Build?</h2>
                    <p className="mt-8 md:text-xl text-lg font-bold font-Poppins text-[#B0C2DC]">Register for Innovate Chicago for a truly epic experience!</p>
                    <RegisterButton link={"/"} />
                ...
                <a className="md:block hidden " href="https://www.google.com/maps/place/John+Hersey+High+School/@42.1040455,-87.9612071,15.96z/data=!4m5!3m4!1s0x880fbbad9a8cbbcd:0xbc3eb41efde43b5f!8m2!3d42.1038234!4d-87.9590565">
