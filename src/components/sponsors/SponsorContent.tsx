...
const SponsorContent: React.FC<{}> = (props) => {
    ...
    return (
        <div className={"px-5 md:px-20 md:max-w-6xl mx-auto my-10 md:my-24"}>
            ...
            <p className={"font-Poppins mt-3"}>Email us about sponsorship inquiries at <a href="mailto:team@hshacks.org" className={"underline text-slate-700"}>team@hshacks.org</a>!</p>
            <br />
        </div>
    );
}
