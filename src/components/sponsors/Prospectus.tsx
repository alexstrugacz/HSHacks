        ...
        <div>
            ...
            <div>
                ...
                <div className='text-center mt-12 mb-24'>
                    ...
                    <p className='font-Poppins text-xl'>Contact <a href='mailto:sponsors@innovatechicago.net' className='font-bold'>sponsors@innovatechicago.net</a> to discuss next steps!</p>
                </div>
            </div>
        </div>
    )
