...
const Prospectus: React.FC<{}> = () => {
    return (
        <div>
            ...
            <div>
                <h1 className='text-[#508ECB] font-Poppins font-bold text-3xl mt-20'><a className=''>Benefits of </a>sponsorship</h1>
            ...
            <h1 className='text-[#508ECB] font-Poppins font-bold text-3xl mt-20 mb-10'>Past Sponsors of HSHacks</h1>
