...
const Prospectus: React.FC<{}> = () => {
    return (
        <div>
            ...
            <div>
                <h1 className='text-orange-400 font-Poppins font-bold text-3xl mt-16'><a className='text-black'>Where you </a>come in</h1>
            ...
            <div>
                <h1 className='text-orange-400 font-Poppins font-bold text-3xl mt-20'><a className='text-black'>Benefits of </a>sponsorship</h1>
            ...
            <div>
                <h1 className='text-orange-400 font-Poppins font-bold text-3xl mt-20'><a className='text-black'>Sponsor </a>packages</h1>
                <p className='mt-3 text-lg text-neutral-600'>Contact <a href='mailto:sponsors@innovatechicago.net' className='hover:underline font-bold text-green-500'>sponsors@innovatechicago.net</a> for next steps or further inquires.</p>
